...
add_fileset_file gaussian_ip.vhd VHDL PATH Fusion/hdl/gaussian_ip.vhd TOP_LEVEL_FILE
...
add_interface_port data1_sink sink_data1 data Input 8
add_interface_port data1_sink sink_eop1 endofpacket Input 1
add_interface_port data1_sink sink_ready1 ready Output 1
add_interface_port data1_sink sink_sop1 startofpacket Input 1
add_interface_port data1_sink sink_valid1 valid Input 1
...
add_interface_port data2_sink sink_data2 data Input 8
add_interface_port data2_sink sink_eop2 endofpacket Input 1
add_interface_port data2_sink sink_ready2 ready Output 1
add_interface_port data2_sink sink_sop2 startofpacket Input 1
add_interface_port data2_sink sink_valid2 valid Input 1
