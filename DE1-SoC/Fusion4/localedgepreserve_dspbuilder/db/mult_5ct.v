//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=1 LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=15 LPM_WIDTHB=24 LPM_WIDTHP=39 LPM_WIDTHS=1 aclr clken clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [38:0]  result_output_reg;
	wire [14:0]    dataa_wire;
	wire [23:0]    datab_wire;
	wire [38:0]    result_wire;
	...
	always @(posedge clock or posedge aclr)
		if (aclr == 1'b1)
			result_output_reg <= 39'b0;
		else
			if (clken == 1'b1)
				result_output_reg <= result_wire[38:0];
